...
def tweet_node_parser(tweet_node,crawl_time_utc):
    ...
    # aggregate dynamic fields
    tweet_item['dynamic_fields'] = []
    dynamics = {
        "like_num": tweet_item["like_num"],
        "comment_num": tweet_item["comment_num"]
    }
    tweet_item['dynamic_fields'].append(dynamics)
